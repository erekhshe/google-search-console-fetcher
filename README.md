...
12. If your project is healthy and you've entered the function name correctly, you will see a message indicating successful execution.
   ...
   **___Log output___** : 
   ...
   [![successful](src/images/guid-for-project-in-lambda/12.png)]{: .thumbnail-image}
   <img src="src/images/guid-for-project-in-lambda/12.png" alt="Alt Text" style="border: 1px solid #ccc; border-radius: 4px; padding: 5px;">
